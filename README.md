...
2. Will check if a budget with the name **ContosoAuto** exist
   - If **"force"** parameter is specified will delete (and recreate in the steps below) it otherwise will skip to the next subscription leaving the existing alert unchanged
